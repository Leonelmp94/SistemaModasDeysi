          ...
          <!--breadcrumbs start-->
           <div id="breadcrumbs-wrapper">
            <div class="container">
              ...
              <div class="col s12 m12 l8" style="background: #BF8A99; text-align: center; color:#1C2637; font-size: 25px; border-radius: 5px; border: #CBCBCB 1px solid; font-weight: bold;">
                <?php echo $hd_titulo; ?>
              </div>
              <div class="col s12 m12 l2">&nbsp;</div>
          ...
          <div class="divider">   </div>
                        ...
                        <div class="input-field col s12" align="right">
                         <!--  <a id="btnLimpiarp" onclick="javascript:window.close();" class="btn waves-effect waves-light orange"><i class="fa fa-save"></i> Salir</a> -->
                          <a class="waves-effect waves-light btn modal-trigger darken-4 orange" href="#modal4">agregar foto  </a>
                          <a id="btnSavep"  class="btn waves-effect waves-light darken-4 blue"><i class="fa fa-save"></i> Guardar</a>
