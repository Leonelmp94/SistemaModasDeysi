          ...
          <div id="breadcrumbs-wrapper">
            <div class="container">
              ...
              <div class="col s12 m4 l4" style="background: white; text-align: center; color:#1C2637; border-radius: 5px; border: #CBCBCB 1px solid">
                <a href="../../../inicio" class="btn waves-effect waves-light darken-4 red"><i class="fa fa-reply"></i> Atras</a>
              <a href="#modal1" class="btn waves-effect darken-4 cyan indigo modal-trigger"><i class="fa fa-plus-square"></i> Nuevo Rol</a>
              </div>
            </div>
            </div>
          </div>
              ...
              <div class="row">
                ...
                <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="configurar.php?lblcode=<?php echo $idrol ?>" class="btn-jh waves-effect waves-light darken-4 blue"><i class="fa fa-cog"></i> Configurar</a>
                          <button id="btndel"  onclick="Eliminar('<?php echo $f["idrol"] ;?>');" data-tooltip="Eliminar Rol: <?php echo $f['Nombre'] ?>" class="btndel btn-jh waves-effect waves-light darken-4 red"> <i class="fa fa-trash"></i> </button>
                        </td>
                      </tr>
                      <?php
                        }
